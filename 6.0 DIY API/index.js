...
app.get('/joke/:id', (req, res)=>{
  ...
  if(joke){
    res.send({"id": jokeId, "joke": joke.jokeText})
  }
  else{
    res.send("error")
  }
...
app.delete('/all', (req, res)=>{
  ...
  if (userKey === masterKey){
    ...
    res.status(404)
       .json({error: "youre not authorised to delete"})
  }
})
app.listen(port, () => {
